...
<!-- functions voor de buttons -->
<script>
    // herlaad de pagina maar dan met variable sort=naam
    function sort_naam() {
        window.location.href = "boeken.php?sort=naam"
    }

    function sort_auteur() {
        window.location.href = "boeken.php?sort=auteur"
    }

    function sort_uitgever() {
        window.location.href = "boeken.php?sort=uitgever"
    }

    function sort_prijs() {
        window.location.href = "boeken.php?sort=prijs"
    }
</script>
            ...
            <div class="row gx-4 align-items-center text-center">
                <div class="">
                    ...
                    try {
                        ...
                        $data = $conn->query("SELECT * FROM boeken ORDER BY " . $sort . "")->fetchAll();
