...
<head>
    ...
    <title>De drie zussen van Auschwitz</title>
            ...
            <div class="row gx-4 gx-lg-5 h-100 align-items-center text-center">
                <div class="">
                    ...
                    try {
                        ...
                        $data = $conn->query("SELECT * FROM boeken WHERE naam LIKE 'De drie zussen van Auschwitz'");
            ...
            <div>
                ...
                if (isset($_POST["Sub"])) {
                    ...
                    try {
                        ...
                        $sql = "UPDATE boeken SET recensie='$txt' WHERE id=7";
