...
<head>
    ...
    <title>De Cock en moord op stand</title>
            ...
            <div class="row gx-4 gx-lg-5 h-100 align-items-center text-center">
                <div class="">
                    ...
                    try {
                        ...
                        $data = $conn->query("SELECT * FROM boeken WHERE naam LIKE 'De Cock en moord op stand'");
            ...
            <div>
                ...
                if (isset($_POST["Sub"])) {
                    ...
                    try {
                        ...
                        $sql = "UPDATE boeken SET recensie='$txt' WHERE id=2";
